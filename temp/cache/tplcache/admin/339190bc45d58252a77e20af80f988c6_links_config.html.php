...
<tr>
	...
	<dl class="default">
		<dt>
			...
			<p>指定蜘蛛：<b><?php if($this->_var['default']['links_robots']): ?><b class="red">已指定</b><?php else: ?>未指定<?php endif; ?></b></p>
		</dt>
...
?>
	<dl>
        <dt>
			...
			<p>指定蜘蛛：<b><?php if($this->_var['vo']['data']['links_robots']): ?><b class="red">已指定</b><?php else: ?>未指定<?php endif; ?></b></p>
			<?php else: ?>
			<p>外链开关：未设置</p>
			<p>调用条数：未设置</p>
			<p>&nbsp;&nbsp;&nbsp;描文本：未设置</p>
...
function edit(id,typename){
	var title=id?'修改':'添加';
	edit_dialog({
		title:title+'外链配置【'+typename+'】',
		url:'?admin-links-edit-cid-'+id,
		posturl:'?admin-links-update',
		width:750,
		height:450
	});
}
