...
?>
    <tr onmouseover=this.bgColor='#EDF8FE'; onmouseout=this.bgColor='#ffffff'; bgcolor='#ffffff'>
	  ...
	  <td align="right" title="<?php echo $this->_var['vo']['typename2']; ?>"><?php echo $this->_var['vo']['typename']; ?>&nbsp;</td>
	  ...
	  <td align="center"><?php echo (!isset($this->_var['vo']['numlog']) || $this->_var['vo']['numlog']==='') ? 0 : $this->_var['vo']['numlog']; ?></td>
      ...
      <td align="center">
		...
		<a href="?admin-collect-edit-id-<?php echo $this->_var['vo']['id']; ?>" class="button button_small" title="修改规则"><i class="typcn typcn-edit"></i>修改</a>
		...
		<a href="?admin-collect-del-id-<?php echo $this->_var['vo']['id']; ?>" onclick='return confirm("确定删除?删除后不可恢复!");' class="button button_small button_remove"><i class="typcn typcn-trash"></i></a>
	  </td>
	  <td>&nbsp;</td>
    </tr>
<?php endforeach; else: ?>
