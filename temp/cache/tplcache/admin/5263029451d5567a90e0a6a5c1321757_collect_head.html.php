<?php if(!defined('INI_XXFSEO')){define('INI_XXFSEO',true);} ?><ul id="admin_sub_title">
...
function addmodel(){
	art.dialog({
		...
		lock:true,
		title:'选择规则类型',
		content:'规则类型：<select name="model" id="model"><option value="body">文章内容</option><option value="pic">图片地址</option></select>',
		ok: function(){
