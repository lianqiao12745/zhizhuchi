...
<input type="hidden" name="con[collect_send_type]" value="1" />
<!-- <tr class="tdbg">
...
<tr>
  ...
  <td><input name="con[collect_send_num_body]" type="text" class="input" value="<?php echo $this->_var['collect_send_num_body']; ?>" size="5"> <span>条，当采集到此数量时才发布，建议100-1000，<font color="red">数据量大时请设置为1000</font></span>
  </td>
</tr>
<tr>
...
<tr>
	  <td>&nbsp;</td>
      <td><button type="submit" class="button button_submit"><i class="typcn typcn-tick"></i>保存设置</button></td>
    </tr>
	</table>
</form>
