...
<div class="divtips">
	<p><b>功能说明：</b>可自定义指定域名首页的TKD，即：首页标题、首页关键词、首页描述和网站名称</p>
</div>
...
<tr>
	<td>
		<font style="line-height:25px;">
			<p>每行一个域名的设置，格式：<font color="#cc0000">域名----网站名称----首页标题----关键词----描述</font>，例子：<font color="#cc0000">seo.com----seo教程网----首页标题----seo关键词,关键词2----seo描述巴拉巴拉</font></p>
			<p>如只设置网站名称，则可以这样：<font color="#cc0000">域名----网站名称</font></p>
			<p><b>支持泛域名</b>，格式： <font color="#cc0000">*.seo.com</font>，<b>泛域名的设置不包括根域名</b>，<font color="#cc0000">支持使用模板标签《<a href="https://www.xxfseo.com/spider/template-tags.html" target="_blank">模板调用标签说明文档</a>》</font></p>
		</font>
	</td>
</tr>
<tr class="tdbg">
