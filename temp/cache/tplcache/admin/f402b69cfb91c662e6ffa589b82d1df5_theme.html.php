...
function search_tpl(){
	art.dialog({
		lock:true,
		title:'查询网站绑定的模板小工具',
		content:'网站地址：<input name="domainstr" type="text" class="input" size="30" id="domainstr" placeholder="http://www.xxfseo.com" /><br><br><div>模板类型：<label><input type="radio" name="dbtype" value="1" checked onclick="$(\'#module_tr\').show();$(\'#domain_tr\').hide();">模型模板</label><label><input type="radio" name="dbtype" value="2" onclick="$(\'#module_tr\').hide();$(\'#domain_tr\').show();">独立分组模板</label></div><br><div id="module_tr">所属模型：<select id="dirname1"><?php $_from=$this->_var['class_list']; if(!is_array($_from) && !is_object($_from)){ settype($_from, 'array'); }; $this->push_vars('', 'vo');if(count($_from)):
    foreach($_from AS $this->_var['vo']):
?><option value="<?php echo $this->_var['vo']['dirname']; ?>"><?php echo $this->_var['vo']['name']; ?></option><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars(); ?></select></div><div id="domain_tr" style="display:none">网站分组：<select id="dirname2"><?php $_from=$this->_var['domainlist']; if(!is_array($_from) && !is_object($_from)){ settype($_from, 'array'); }; $this->push_vars('', 'vo');if(count($_from)):
    foreach($_from AS $this->_var['vo']):
?><option value="<?php echo $this->_var['vo']['dirname']; ?>"><?php echo $this->_var['vo']['name']; ?></option><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars(); ?></select></div>',
		ok: function(){
			if($('#domainstr').val()!=''){
...
?>
	<li <?php if($this->_var['type'] == $this->_var['vo']['dirname']): ?>class="cur"<?php endif; ?>><a href="?admin-theme-index-type-<?php echo $this->_var['vo']['dirname']; ?>-mtype-pc"><?php echo $this->_var['vo']['name']; ?>(<font color="#ff6600"><b><?php if($this->_var['vo']['num_pc']): ?><?php echo $this->_var['vo']['num_pc']; ?><?php else: ?>0<?php endif; ?></b></font>)</a></li>
...
<?php $_from=$this->_var['domainlist']; if(!is_array($_from) && !is_object($_from)){ settype($_from, 'array'); }; $this->push_vars('k', 'vo');if(count($_from)):
    foreach($_from AS $this->_var['k'] => $this->_var['vo']):
?>
	<li <?php if($this->_var['type'] == $this->_var['vo']['dirname']): ?>class="cur"<?php endif; ?>><a href="?admin-theme-index-type-<?php echo $this->_var['vo']['dirname']; ?>-mtype-pc-dm-1"><?php echo $this->_var['vo']['name']; ?>(<b style="color:#ff6600;"><?php if($this->_var['vo']['num_pc']): ?><?php echo $this->_var['vo']['num_pc']; ?><?php else: ?>0<?php endif; ?></b>)</a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars(); ?>
</ul>
...
?>
	...
	<li>
		<p class="picbox"><font  class="theme_num"><?php echo $this->_var['vo']['num']; ?></font><img src="<?php echo $this->_var['vo']['pic']; ?>"><font  class="theme_name"><?php echo $this->_var['vo']['typename']; ?></font></p>
...
<?php $_from=$this->_var['class_list']; if(!is_array($_from) && !is_object($_from)){ settype($_from, 'array'); }; $this->push_vars('k', 'vo');if(count($_from)):
    foreach($_from AS $this->_var['k'] => $this->_var['vo']):
?>
	<li <?php if($this->_var['type'] == $this->_var['vo']['dirname']): ?>class="cur"<?php endif; ?>><a href="?admin-theme-index-type-<?php echo $this->_var['vo']['dirname']; ?>-mtype-mobile"><?php echo $this->_var['vo']['name']; ?>(<b><font color="#ff6600"><?php if($this->_var['vo']['num_mobile']): ?><?php echo $this->_var['vo']['num_mobile']; ?><?php else: ?>0<?php endif; ?></font></b>)</a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars(); ?>
</ul>
<ul class="classlist">
<li><a href="javascript:" class="typefirst">分组模板：</a></li>
...
<?php $_from=$this->_var['domainlist']; if(!is_array($_from) && !is_object($_from)){ settype($_from, 'array'); }; $this->push_vars('k', 'vo');if(count($_from)):
    foreach($_from AS $this->_var['k'] => $this->_var['vo']):
?>
	<li <?php if($this->_var['type'] == $this->_var['vo']['dirname']): ?>class="cur"<?php endif; ?>><a href="?admin-theme-index-type-<?php echo $this->_var['vo']['dirname']; ?>-mtype-mobile-dm-1"><?php echo $this->_var['vo']['name']; ?>(<b style="color:#ff6600;"><?php if($this->_var['vo']['num_mobile']): ?><?php echo $this->_var['vo']['num_mobile']; ?><?php else: ?>0<?php endif; ?></b>)</a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars(); ?>
</ul>
<table border="0" align="center" cellpadding="8" cellspacing="1" class="tableConfig">
<tr class="item_title">
