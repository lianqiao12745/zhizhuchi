...
(function($){
	...
	function write(){
		...
		+"     <label for=\"wechat\"><input type=\"radio\" id=\"wechat\" class=\"reward-radio\" value=\"0\" checked=\"checked\" name=\"reward-way\" />????????????</label>"
		+ "     <label for=\"qqqb\"><input type=\"radio\" id=\"qqqb\" class=\"reward-radio\" value=\"1\" name=\"reward-way\" />QQ??????</label>"
		+"     <label for=\"alipay\"><input type=\"radio\" id=\"alipay\" class=\"reward-radio\" value=\"2\" name=\"reward-way\" />?????????</label>"
		+ "     <label for=\"bdBaifubao\"><input type=\"radio\" id=\"bdBaifubao\" class=\"reward-radio\" value=\"3\" name=\"reward-way\" />????????????</label>"
		+ "    </div>"
		+ "    <div class=\"ds-payment-img\">"
		+ "     <div class=\"qrcode-img qrCode_0\" id=\"qrCode_0\">"
		+ "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(60, 175, 54\">"
		+ "       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src=\"//zhangliseo.com/wp-content/uploads/wechat.jpg\" />"
		+ "      </div>"
		...
		+ "       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\" src=\"//zhangliseo.com/wp-content/uploads/qqqb.png\" />"
		+ "      </div>"
		+ "      <p class=\"qrcode-tip\">??????</p>"
		+ "     </div>"
		+ "     <div class=\"qrcode-img qrCode_2\" id=\"qrCode_2\">"
		+ "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(235, 95, 1\">"
		+ "       <img  class=\"qrcode-img qrCode_2\" id=\"qrCode_2\" src=\"//zhangliseo.com/wp-content/uploads/zfb.jpg\" />"
		+ "      </div>"
		+ "      <p class=\"qrcode-tip\">??????</p>"
		+ "     </div>"
		+ "     <div class=\"qrcode-img qrCode_3\" id=\"qrCode_3\">"
		+ "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(225, 6, 2\">"
		+ "         <img  class=\"qrcode-img qrCode_3\" id=\"qrCode_3\" src=\"//zhangliseo.com/wp-content/uploads/bdqb.png \" />"
		+ "      </div>"
		+ "      <p class=\"qrcode-tip\">??????</p>"
		+ "     </div>"
		+ "    </div>"
